...
export function DemoHeader({ className }: HeaderProps) {
  return (
    <div className={cn('w-full space-y-6 text-center', className)}>
      ...
      {/* Main Headline */}
      <h1 className="text-5xl  lg:text-[30px] font-bold tracking-tight bg-gradient-to-r from-slate-100 to-slate-300 bg-clip-text text-transparent leading-tight">
        Schedule a free demo
      </h1>
      
      {/* Subheading */}
    <p className="mx-auto max-w-5xl text-lg lg:text-[18px] text-slate-400 leading-relaxed font-light">
